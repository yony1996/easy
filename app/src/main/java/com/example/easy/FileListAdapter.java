...
public class FileListAdapter extends BaseAdapter {
    private ArrayList<FileList> lista = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tx = convertView.findViewById(R.id.txt_list);
        tx.setText(fich.getName());
        TextView tx2 = convertView.findViewById(R.id.txt_list_absolute_path);
